...
import { BOX_LIST } from "../../constants";
import { ENDPOINT_AIRDROP_NORMAL_BOX } from "../../constants/endpoint";
import { _convertCsvToArray } from "../../settings/format";
import { post } from "../../utils/api";

export default function BoxByType() {
    ...
    <>
      ...
      >
        <Grid container spacing={1}>
          <Grid item xs={12}>
            <Typography variant="h5">Airdrop NFT Box</Typography>
          </Grid>
          <Grid item xs={12}>
            <Divider />
            <br />
