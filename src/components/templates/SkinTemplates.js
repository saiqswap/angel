...
import { Add, Close, Edit, TextFormatSharp } from "@material-ui/icons";
...
export default function SkinTemplates() {
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <TextField
                        ...
                        value={defaultData.properties.riPerformanceBonus}
                        onChange={(e) => {
                          let temp = { ...defaultData };
                          temp.properties.riPerformanceBonus = e.target.value;
                          setDefaultData(temp);
                        }}
                      />
                    </Grid>
